...
// node_modules/shamirs-secret-sharing/constants.js
...
// node_modules/shamirs-secret-sharing/buffer.js
...
var _Buffer = class _Buffer extends Uint8Array {
  static get Buffer() {
    return _Buffer;
  }
  /**
...
__publicField(_Buffer, "alloc", alloc);
__publicField(_Buffer, "byteLength", getByteLength);
__publicField(_Buffer, "compare", compare);
__publicField(_Buffer, "concat", concat);
__publicField(_Buffer, "from", from);
__publicField(_Buffer, "isBufferLike", isBufferLike);
__publicField(_Buffer, "random", randomBytes);
var Buffer = _Buffer;
TypedArrayPrototypeSet.add(Buffer.prototype);
var buffer_default = Buffer;

// node_modules/shamirs-secret-sharing/table.js
...
// node_modules/shamirs-secret-sharing/codec.js
...
function encode(id, data) {
  id = typeof id === "number" ? id : (
    /** @type {number} */
    parseInt(Buffer.from(id).toString(), 16)
  );
...
// node_modules/shamirs-secret-sharing/combine.js
...
function parse(input) {
  ...
  const string = isBufferLike(input) ? Buffer.from(input).toString("hex") : input;
...
// node_modules/shamirs-secret-sharing/split.js
...
// node_modules/shamirs-secret-sharing/index.js
var VERSION = "2";
...
export {
  ...
  shamirs_secret_sharing_default as default,
  split_default as split
};
//# sourceMappingURL=shamirs-secret-sharing.js.map
